/*
 * $Id: DragonDragonTimedTeleportScroll.java,v 1.221 2013/03/04 22:05:23 edi18028 edited by szyg Exp $
 */
 ...
 */
public class DragonTimedTeleportScroll extends TeleportScroll {

	private static final Logger logger = Logger.getLogger(DragonTimedTeleportScroll.class);

		private static final List<String> MAP_ARRAY = Arrays.asList("0_dragon_land_n","-1_dragon_land_cave","int_dragon_house_1","int_dragon_house_2","int_dragon_house_3","int_dragon_house_4","int_dragon_house_5","int_dragon_house_6","int_dragon_workshop","int_dragon_castle","int_dragon_castle_room_1","int_dragon_castle_room_2","int_dragon_castle_room_3","int_dragon_castle_room_4","int_dragon_castle_room_5","int_dragon_castle_room_6","int_dragon_castle_dragon_npc","int_dragon_castle_dragon");
		
		private static final String STARTING_MAP = "0_dragon_land_s"; 
	...
	public boolean teleportBack(final Player player) {
		...
		if(targetZoneName.equals(STARTING_MAP)) {
			int i=0;
			if(player.getZone().getName().contains(STARTING_MAP)) {
				...
				for(final String mapsName : MAP_ARRAY) {
	 ...
	 * @param attributes
	 */
	public DragonTimedTeleportScroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public DragonTimedTeleportScroll(final DragonTimedTeleportScroll item) {
		super(item);
	}

/*
 * $Id: AngelScroll.java,v 1.10 2013/03/03 11:22:33 edi18028 edited by szyg Exp $
 */
/***************************************************************************
 ...
 */
public class AngelScroll extends AngelTimedTeleportScroll {
	 ...
	 * @param attributes
	 */
	public AngelScroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public AngelScroll(final AngelScroll item) {
		super(item);
	}

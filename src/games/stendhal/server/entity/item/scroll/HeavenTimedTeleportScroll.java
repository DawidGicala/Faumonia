/*
 * $Id: DragonHeavenTimedTeleportScroll.java,v 1.221 2013/03/04 22:05:23 edi18028 edited by szyg Exp $
 */
 ...
 */
public class HeavenTimedTeleportScroll extends TeleportScroll {

	private static final Logger logger = Logger.getLogger(HeavenTimedTeleportScroll.class);

		private static final List<String> MAP_ARRAY = Arrays.asList("int_testing_grid");
		
		private static final String STARTING_MAP = "heaven"; 
	 ...
	 * @param attributes
	 */
	public HeavenTimedTeleportScroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public HeavenTimedTeleportScroll(final HeavenTimedTeleportScroll item) {
		super(item);
	}

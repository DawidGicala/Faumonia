/*
 * $Id: DragonGiantTimedTeleportScroll.java,v 1.221 2013/03/04 22:05:23 edi18028 edited by szyg Exp $
 */
 ...
 */
public class GiantTimedTeleportScroll extends TeleportScroll {

	private static final Logger logger = Logger.getLogger(GiantTimedTeleportScroll.class);

		private static final List<String> MAP_ARRAY = Arrays.asList("-2_giant_cavern","-3_giant_cavern","-4_giant_cavern","-5_giant_cavern","-6_giant_cavern");
		
		private static final String STARTING_MAP = "-1_giant_cavern"; 
	 ...
	 * @param attributes
	 */
	public GiantTimedTeleportScroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public GiantTimedTeleportScroll(final GiantTimedTeleportScroll item) {
		super(item);
	}

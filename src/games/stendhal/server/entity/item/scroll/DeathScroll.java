/*
 * $Id: DeathScroll.java,v 1.10 2013/03/03 11:22:33 edi18028 edited by szyg Exp $
 */
/***************************************************************************
 ...
 */
public class DeathScroll extends DeathTimedTeleportScroll {
	 ...
	 * @param attributes
	 */
	public DeathScroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public DeathScroll(final DeathScroll item) {
		super(item);
	}

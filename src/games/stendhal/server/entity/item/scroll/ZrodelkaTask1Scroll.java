/*
 * $Id: ZrodelkaTask1Scroll,v 1.10 2020/11/28 15:27:33 davvids Exp $
 */
/***************************************************************************
 ...
 */
public class ZrodelkaTask1Scroll extends TimedTeleportScroll {
	
	private static final long DELAY = 5 * MathHelper.MILLISECONDS_IN_ONE_MINUTE;
	
	/**
	 * Creates a new timed marked ZrodelkaTask1Scroll scroll.
	 * 
	 * @param name
	 * @param clazz
	 * @param subclass
	 * @param attributes
	 */
	public ZrodelkaTask1Scroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public ZrodelkaTask1Scroll(final ZrodelkaTask1Scroll item) {
		super(item);
	}
	
	@Override
	protected boolean useTeleportScroll(final Player player) {
		final String QUEST_SLOT = "zrodelka_nr_1";
		long lastuse = -1;

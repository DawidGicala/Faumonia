/*
 * $Id: DragonScroll.java,v 1.10 2013/03/03 11:22:33 edi18028 edited by szyg Exp $
 */
/***************************************************************************
 ...
 */
public class DragonScroll extends DragonTimedTeleportScroll {
	 ...
	 * @param attributes
	 */
	public DragonScroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public DragonScroll(final DragonScroll item) {
		super(item);
	}

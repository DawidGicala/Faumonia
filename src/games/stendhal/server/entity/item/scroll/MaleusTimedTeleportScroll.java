/*
 * $Id: DragonMaleusTimedTeleportScroll.java,v 1.221 2013/03/04 22:05:23 edi18028 edited by szyg Exp $
 */
 ...
 */
public class MaleusTimedTeleportScroll extends TeleportScroll {

	private static final Logger logger = Logger.getLogger(MaleusTimedTeleportScroll.class);

		private static final List<String> MAP_ARRAY = Arrays.asList("int_testing_grid");
		
		private static final String STARTING_MAP = "malleus_plain"; 
	 ...
	 * @param attributes
	 */
	public MaleusTimedTeleportScroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public MaleusTimedTeleportScroll(final MaleusTimedTeleportScroll item) {
		super(item);
	}

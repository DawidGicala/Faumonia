/*
 * $Id: HeavenScroll.java,v 1.10 2013/03/03 11:22:33 edi18028 edited by szyg Exp $
 */
/***************************************************************************
 ...
 */
public class HeavenScroll extends DragonTimedTeleportScroll {
	 ...
	 * @param attributes
	 */
	public HeavenScroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public HeavenScroll(final HeavenScroll item) {
		super(item);
	}

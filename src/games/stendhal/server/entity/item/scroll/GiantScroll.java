/*
 * $Id: GiantScroll.java,v 1.10 2013/03/03 11:22:33 edi18028 edited by szyg Exp $
 */
/***************************************************************************
 ...
 */
public class GiantScroll extends GiantTimedTeleportScroll {
	 ...
	 * @param attributes
	 */
	public GiantScroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public GiantScroll(final GiantScroll item) {
		super(item);
	}

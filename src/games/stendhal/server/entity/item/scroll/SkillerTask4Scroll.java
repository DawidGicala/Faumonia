/*
 * $Id: SkillerTask4Scroll,v 1.10 2020/11/28 15:27:33 davvids Exp $
 */
/***************************************************************************
 ...
 */
public class SkillerTask4Scroll extends TimedTeleportScroll {
	
	private static final long DELAY = 5 * MathHelper.MILLISECONDS_IN_ONE_MINUTE;
	
	/**
	 * Creates a new timed marked SkillerTask4Scroll scroll.
	 * 
	 * @param name
	 * @param clazz
	 * @param subclass
	 * @param attributes
	 */
	public SkillerTask4Scroll(final String name, final String clazz, final String subclass,
	 ...
	 *            item to copy
	 */
	public SkillerTask4Scroll(final SkillerTask4Scroll item) {
		super(item);
	}
	
	@Override
	protected boolean useTeleportScroll(final Player player) {
		final String QUEST_SLOT = "skiller_nr_4";
		long lastuse = -1;

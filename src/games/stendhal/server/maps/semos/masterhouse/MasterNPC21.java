/* $Id: MasterNPC21.java,v 1.19 2020/12/06 22:05:20 davvids Exp $ */
/***************************************************************************
...
public class MasterNPC21 implements ZoneConfigurator {
   private final ShopList shops = SingletonRepository.getShopList();
	...
	private void buildRockArea(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Mistrz Faumonii XXI") {
			...
			protected void createDialog() {
			  // This greeting is mostly not used as the quests override it
				...
				addHelp("Kolejne zadanie dostępne jest dla graczy od 250 poziomu doświadczenia.");
		...
		npc.setPosition(3, 115);
		npc.setDirection(Direction.RIGHT);
		npc.initHP(100);
		npc.setDescription("Oto Mistrz Faumonii XXI. Wygląda ci na kogoś bardzo doświadczonego. Może powinieneś zapytać go o zadanie?");
		zone.add(npc);
	}
}

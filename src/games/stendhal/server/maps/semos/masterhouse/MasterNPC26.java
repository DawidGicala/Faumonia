/* $Id: MasterNPC26.java,v 1.19 2020/12/08 1:54:20 davvids Exp $ */
/***************************************************************************
...
public class MasterNPC26 implements ZoneConfigurator {
   private final ShopList shops = SingletonRepository.getShopList();
	...
	private void buildRockArea(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Mistrz Faumonii XXVI") {
			...
			protected void createDialog() {
			  // This greeting is mostly not used as the quests override it
				...
				addHelp("Kolejne zadanie dostępne jest dla graczy od 350 poziomu doświadczenia.");
		...
		npc.setPosition(25, 137);
		npc.setDirection(Direction.LEFT);
		npc.initHP(100);
		npc.setDescription("Oto Mistrz Faumonii XXVI. Wygląda ci na kogoś bardzo doświadczonego. Może powinieneś zapytać go o zadanie?");
		zone.add(npc);
	}
}

/* $Id: MasterNPC27.java,v 1.19 2020/12/08 13:12:20 davvids Exp $ */
/***************************************************************************
...
public class MasterNPC27 implements ZoneConfigurator {
   private final ShopList shops = SingletonRepository.getShopList();
	...
	private void buildRockArea(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Mistrz Faumonii XXVII") {
			...
			protected void createDialog() {
			  // This greeting is mostly not used as the quests override it
				...
				addHelp("Kolejne zadanie dostępne jest dla graczy od 400 poziomu doświadczenia.");
		...
		npc.setPosition(3, 148);
		npc.setDirection(Direction.RIGHT);
		npc.initHP(100);
		npc.setDescription("Oto Mistrz Faumonii XXVII. Wygląda ci na kogoś bardzo doświadczonego. Może powinieneś zapytać go o zadanie?");
		zone.add(npc);
	}
}

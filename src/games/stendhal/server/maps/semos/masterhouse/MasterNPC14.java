/* $Id: MasterNPC14.java,v 1.19 2020/12/03 11:30:41 davvids Exp $ */
/***************************************************************************
...
public class MasterNPC14 implements ZoneConfigurator {
   private final ShopList shops = SingletonRepository.getShopList();
	...
	private void buildRockArea(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Mistrz Faumonii XIV") {
			...
			protected void createDialog() {
			  // This greeting is mostly not used as the quests override it
				...
				addHelp("Kolejne zadanie dostępne jest dla graczy od 110 poziomu doświadczenia.");
		...
		npc.setPosition(25, 71);
		npc.setDirection(Direction.LEFT);
		npc.initHP(100);
		npc.setDescription("Oto Mistrz Faumonii XIV. Wygląda ci na kogoś bardzo doświadczonego. Może powinieneś zapytać go o zadanie?");
		zone.add(npc);
	}
}

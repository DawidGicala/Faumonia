/* $Id: MasterNPC25.java,v 1.19 2020/12/08 1:54:20 davvids Exp $ */
/***************************************************************************
...
public class MasterNPC25 implements ZoneConfigurator {
   private final ShopList shops = SingletonRepository.getShopList();
	...
	private void buildRockArea(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Mistrz Faumonii XXV") {
		...
		npc.setPosition(3, 137);
		npc.setDirection(Direction.RIGHT);
		npc.initHP(100);
		npc.setDescription("Oto Mistrz Faumonii XXV. Wygląda ci na kogoś bardzo doświadczonego. Może powinieneś zapytać go o zadanie?");
		zone.add(npc);
	}
}

/* $Id: MasterNPC30.java,v 1.19 2020/12/09 13:50:20 davvids Exp $ */
/***************************************************************************
...
public class MasterNPC30 implements ZoneConfigurator {
   private final ShopList shops = SingletonRepository.getShopList();
	...
	private void buildRockArea(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Mistrz Faumonii XXX") {
			...
			protected void createDialog() {
			  // This greeting is mostly not used as the quests override it
				...
				addHelp("Ostatnie główne zadanie dostępne jest dla graczy od 550 poziomu doświadczenia.");
		...
		npc.setPosition(25, 159);
		npc.setDirection(Direction.LEFT);
		npc.initHP(100);
		npc.setDescription("Oto Mistrz Faumonii XXX. Wygląda ci na kogoś bardzo doświadczonego. Może powinieneś zapytać go o zadanie?");
		zone.add(npc);
	}
}

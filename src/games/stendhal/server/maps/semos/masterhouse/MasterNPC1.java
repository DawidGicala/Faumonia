		...
		final SpeakerNPC npc = new SpeakerNPC("Mistrz Faumonii I") {
			...
			protected void createDialog() {
			  // This greeting is mostly not used as the quests override it
				addGreeting("Witaj wojowniku! Widze, że jesteś tu nowy. Wykonaj dla mnie pewne #zadanie a naucze cię podstaw gry. W tym celu napisz #zadanie. Jeżeli skończyłeś swoje zadanie to napisz #gotowe");
				addHelp("Aktualnie nic nie potrzebuje.");

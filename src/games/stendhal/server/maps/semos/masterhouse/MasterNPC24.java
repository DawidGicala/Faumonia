/* $Id: MasterNPC24.java,v 1.19 2020/12/07 22:14:20 davvids Exp $ */
/***************************************************************************
...
public class MasterNPC24 implements ZoneConfigurator {
   private final ShopList shops = SingletonRepository.getShopList();
	...
	private void buildRockArea(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Mistrz Faumonii XXIV") {
			...
			protected void createDialog() {
			  // This greeting is mostly not used as the quests override it
				...
				addHelp("Kolejne zadanie dostępne jest dla graczy od 320 poziomu doświadczenia.");
		...
		npc.setPosition(25, 126);
		npc.setDirection(Direction.LEFT);
		npc.initHP(100);
		npc.setDescription("Oto Mistrz Faumonii XXIV. Wygląda ci na kogoś bardzo doświadczonego. Może powinieneś zapytać go o zadanie?");
		zone.add(npc);
	}
}

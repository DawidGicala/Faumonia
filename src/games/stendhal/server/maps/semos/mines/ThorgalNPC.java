	...
	private void buildThorgal(final StendhalRPZone zone) {
		final SpeakerNPC Thorgal = new SpeakerNPC("Thorgal") {
			...
			protected void createDialog() {
				...
				addGreeting("Powitanie, podróżniku! Jestem Thorgal, wędrowiec, który od lat przemierza tunele chaosu. Jeśli masz odwagę zmierzyć się z niebezpieczeństwami tych mrocznych podziemi, mogę mieć dla Ciebie pewne zadanie.");

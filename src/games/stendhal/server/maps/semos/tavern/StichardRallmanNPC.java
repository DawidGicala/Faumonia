	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC stallman = new SpeakerNPC("Stichard Rallman") {
			...
			protected void createDialog() {
				addGreeting("Witojcies w grze #FaumoniaOnline! Grać mozecie bez płacenia dudków");
				addJob("Głoszę idee #wolnego oprogramowania!");
				addHelp("Pomóż #Faumonii być jeszcze lepszym. Poświęć swój czas, powiedz znajomym, aby zagrali, twórz mapy.");
				...
				addReply("pol",
					"FaumoniaOnline jest właśnie #wolnym oprogramowaniem na licencji #GNU #GPL. Możesz ją uruchamiać, kopiować, dystrybuować, studiować, zmieniać i poprawiać to oprogramowanie.");

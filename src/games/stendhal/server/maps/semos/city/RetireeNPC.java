	...
	private void buildNPC(StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Diogenes") {
			...
			public void createDialog() {
				...
				addHelp("Nie mogę Ci pomóc, ale ty możesz pomóc FaumoniaOnline mówiąc znajomym i pomagając w rozwoju gry! Wejdź na http://www.faumonia.pl i zobacz jak możesz nam pomóc!");
				addGoodbye();
		...
		add(ConversationStates.ATTENDING, Arrays.asList("cleanme!", "wyczyść mnie!"), null, ConversationStates.ATTENDING, "Co?",
			...
			protected void createPath() {
				...
				nodes.add(new Node(85, 43));
				nodes.add(new Node(88, 43));
				nodes.add(new Node(88, 45));
				nodes.add(new Node(94, 45));
				nodes.add(new Node(94, 44));
				nodes.add(new Node(98, 44));
				nodes.add(new Node(98, 29));
				nodes.add(new Node(85, 29));
				nodes.add(new Node(85, 27));
				nodes.add(new Node(67, 27));
				nodes.add(new Node(67, 32));
				nodes.add(new Node(85, 32));
				setPath(new FixedPath(nodes, true));
			}
			
		};
		npc.setPosition(87, 43);

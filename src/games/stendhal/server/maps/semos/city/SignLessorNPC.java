...
public class SignLessorNPC implements ZoneConfigurator {
	...
	public void configureZone(StendhalRPZone zone,
		...
		final Shape shape = new Rectangle(85, 48, 17, 1);
	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Gordon") {
			...
			protected void createPath() {
				...
				nodes.add(new Node(83,50));
				nodes.add(new Node(101, 50));
				nodes.add(new Node(101, 51));
				nodes.add(new Node(83, 51));
				setPath(new FixedPath(nodes, true));
			}
			
		};
		npc.setPosition(83, 50);

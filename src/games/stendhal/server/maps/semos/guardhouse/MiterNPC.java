	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Miter") {
			...
			public void createDialog() {
				addGreeting("Witaj, jestem Miter. Sprzedaje podstawowy ekwipunek aby poznać moją ofertę napisz #oferta. Mogę cie również uleczyć wystarczy, że napiszesz #ulecz. Jesli potrzebujesz w czymś pomocy napisz #'/support tekst'");
				addJob("Moja niezwykła moc pomaga mi uleczyć rany. Sprzedaję także lecznicze mikstury i ekwipunek.");
				addHelp("Mogę Cię za darmo uleczyć. Powiedz tylko #ulecz. Moge też sprzedać ci swój stary ekwipunek w tym celu napisz #oferta. Statystyki przedmiotów możesz sprawdzić klikając w #'Menu' w prawym górnym rogu a następnie '#Lista przedmiotów'");

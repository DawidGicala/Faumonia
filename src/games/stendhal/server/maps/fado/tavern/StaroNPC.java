/* $Id: StaroNPC.java,v 1.19 2020/12/04 11:59:27 davvids Exp $ */
/***************************************************************************
...
public class StaroNPC implements ZoneConfigurator {
	/**
	 * Configure a zone.
	 *
	...
	private void buildElementalArea(final StendhalRPZone zone) {
		final SpeakerNPC elemental = new SpeakerNPC("Staro") {
		...
		elemental.setDescription("Oto Staro.");
		elemental.setEntityClass("verger2npc");
		elemental.setPosition(23, 20);

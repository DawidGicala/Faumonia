/* $Id: SmithNPC.java,v 1.19 2020/11/01 8:24:27 szyg edited by davvids Exp $ */
/***************************************************************************
...
public class ElementalNPC implements ZoneConfigurator {
	...
	private void buildElementalArea(final StendhalRPZone zone) {
		final SpeakerNPC elemental = new SpeakerNPC("Żywioł Ognia") {
			...
			protected void createDialog() {
				...
				add(
				        ...
				        null,
				        ConversationStates.ATTENDING,
				        "Kto Ci to powiedział!?! *kaszlnięcie* Nie rozpowiadaj o tym nikomu - mogę wykuć dla Ciebie specjalny przedmiot, ale będziesz musiał wykonać #zadanie",
				        null);
			}
		};

		elemental.setDescription("Oto Żywioł Ognia. Czujesz przerażający gorąc stojąc w jego pobliżu.");

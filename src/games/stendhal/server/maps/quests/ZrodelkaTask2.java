/* $Id: ZrodelkaTask2.java,v 1.46 2020/11/29 14:26:42 davvids Exp $ */
/***************************************************************************
...
import games.stendhal.server.entity.item.scroll.ZrodelkaTask2Scroll;
 ...
 * </ul>
 */
public class ZrodelkaTask2 extends AbstractQuest {
	...
	private static final String QUEST_SLOT = "zrodelka_nr_2";
	...
	private void step_1() {
		final SpeakerNPC npc = npcs.get("Zach");
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				ConversationStates.ATTENDING, 
				"W porządku oto twój bilet na źródełka treningowe. Gdy go użyjesz to wrócisz za około 2 godziny. Jeśli będziesz chciał wcześniej wrócić to skorzystaj ze schodów.",
				new MultipleActions(
						new DropItemAction("money", REQUIRED_MONEY),
						new EquipItemAction("źródełka treningowe II", 1, true),
						new TeleportAction("int_semos_skill_house", 13, 27, Direction.RIGHT),
	...
	public void addToWorld() {
		...
		SingletonRepository.getLoginNotifier().addListener(new LoginListener() {
			public void onLoggedIn(final Player player) {
			    ZrodelkaTask2Scroll scroll = (ZrodelkaTask2Scroll) SingletonRepository.getEntityManager().getItem("źródełka treningowe II");

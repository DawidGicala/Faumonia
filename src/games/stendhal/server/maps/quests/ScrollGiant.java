/* $Id: ScrollGiant.java,v 1.46 2012/04/19 18:26:42 kymara Exp $ */
/***************************************************************************
...
import games.stendhal.server.entity.item.scroll.GiantScroll;
 ...
 * PARTICIPANTS:
 * <ul>
 * <li>OlbrzymiNPC, a dealer in zwój olbrzymów
 * </ul>
 *
 * STEPS:
 * <ul>
 * <li>The NPC sells zwój olbrzymów to players above level 300</li>
 ...
 * </ul>
 */
public class ScrollGiant extends AbstractQuest {
	...
	private static final String QUEST_SLOT = "olbrzymi_bilet";
	...
	private void step_1() {
		final SpeakerNPC npc = npcs.get("OlbrzymiNPC");
		...
		npc.add(
			...
			"Wróciłeś po kolejny zwój olbrzymów?", null);
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				ConversationStates.ATTENDING, 
				"W porządku oto twój zwój olbrzymów. Gdy użyjesz to wrócisz za około 3 godziny. Jeśli będziesz chciał wcześniej wrócić to skorzystaj tam stan na herbie Zakopanego, który zabierze Ciebie z powrotem.",
				new MultipleActions(
						new DropItemAction("money", REQUIRED_MONEY),
						new EquipItemAction("zwój olbrzymów", 1, true),
		...
		npc.add(ConversationStates.ATTENDING,
			Arrays.asList("deal", "ticket", "zwój olbrzymów", "yes", "tak"),
			new LevelGreaterThanCondition(REQUIRED_LEVEL-1),
			ConversationStates.ATTENDING,
	...
	public void addToWorld() {
		...
		SingletonRepository.getLoginNotifier().addListener(new LoginListener() {
			public void onLoggedIn(final Player player) {
			    GiantScroll scroll = (GiantScroll) SingletonRepository.getEntityManager().getItem("zwój olbrzymów");
		...
		fillQuestInfo(
				"zwój olbrzymów",
				"zwój olbrzymów wysyła na wycieczkę do obcej krainy pokrytej piaskiem.",
				false);
		step_1();

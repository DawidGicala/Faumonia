/* $Id: SkillerTask4.java,v 1.46 2020/11/29 14:26:42 davvids Exp $ */
/***************************************************************************
...
import games.stendhal.server.entity.item.scroll.SkillerTask4Scroll;
 ...
 * </ul>
 */
public class SkillerTask4 extends AbstractQuest {
	...
	private static final String QUEST_SLOT = "skiller_nr_4";
	...
	private void step_1() {
		final SpeakerNPC npc = npcs.get("Azen");
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				ConversationStates.ATTENDING, 
				"W porządku oto twój bilet na arenę treningową. Gdy go użyjesz to wrócisz za około 24 godziny. Jeśli będziesz chciał wcześniej wrócić to skorzystaj ze schodów.",
				new MultipleActions(
						new DropItemAction("money", REQUIRED_MONEY),
						new EquipItemAction("bilet treningowy IV", 1, true),
						new TeleportAction("int_semos_skill_house", 18, 5, Direction.LEFT),
	...
	public void addToWorld() {
		...
		SingletonRepository.getLoginNotifier().addListener(new LoginListener() {
			public void onLoggedIn(final Player player) {
			    SkillerTask4Scroll scroll = (SkillerTask4Scroll) SingletonRepository.getEntityManager().getItem("bilet treningowy IV");

	...
	*/
	...
	private void createDialogNowWeKnowLocation() {
		...
		addReply(
				 ...
				 "Powinieneś się dowiedzieć o #cenę przed kupnem i sprawdzić naszą broszurę #http://www.faumonia.pl/galerie-zdj%C4%99%C4%87/domki.");
		addReply(Arrays.asList("really", "naprawdę"),
				 "Tak jest naprawdę, naprawdę, naprawdę. Naprawdę.");
		addOffer("Sprzedaję domy, aby zobaczyć jak wyglądają wejdź na stronę #http://www.faumonia.pl/galerie-zdj%C4%99%C4%87/domki i przekonaj się. Później zapytaj mnie o #cenę, gdy będziesz gotowy.");
		addHelp("Możesz kupić dom o ile będzie dostępny. Jeżeli będziesz mógł zapłacić #cenę to dam Tobie klucz. Jako właściciel domu będziesz mógł kupować dodatkowe klucze do niego i dawać przyjaciołom. Wejdź na #http://www.faumonia.pl/galerie-zdj%C4%99%C4%87/domki i zobacz wnętrza domów oraz więcej szczegółów.");
		addQuest("Możesz kupić u mnie domy. Zapytaj mnie o #cenę jeżeli jesteś zainteresowany. Może chcesz najpierw zobaczyć naszą broszurę http://www.faumonia.pl/galerie-zdj%C4%99%C4%87/domki.");

...
final class AdosHouseSeller extends HouseSellerNPCBase {
	...
	private void init() {
		...
		addJob("Jestem agentem nieruchomości, po prostu sprzedaje domy w Ados. Zapytaj o #cenę jeżeli jesteś zainteresowany. Nasz katalog domów znajduje się na  #http://www.faumonia.pl/galerie-zdj%C4%99%C4%87/domki.");

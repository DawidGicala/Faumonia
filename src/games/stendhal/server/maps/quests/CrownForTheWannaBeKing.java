...
public class CrownForTheWannaBeKing extends AbstractQuest {
	 ...
	 */
	protected static final String NEEDED_ITEMS = "żelazo=242;sztabka mithrilu=186;sztabka złota=203;szmaragd=304;szafir=293;rubin=282;diament=18;obsydian=221";
	 ...
	 */
	private static final double ATK_REWARD_RATE = 0.0005;

	/**
	 * how much XP is given as the reward.
	 */
	private static final int XP_REWARD = 1000000;

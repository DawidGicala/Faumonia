/* $Id: ScrollHeaven.java,v 1.46 2012/04/19 18:26:42 kymara Exp $ */
/* $Id: ScrollHeaven.java,v 1.46 2012/04/19 18:26:42 kymara Exp $ */
/***************************************************************************
...
import games.stendhal.server.entity.item.scroll.HeavenScroll;
 ...
 * PARTICIPANTS:
 * <ul>
 * <li>HeavenNPC, a dealer in bilet do niebios
 * </ul>
 *
 * STEPS:
 * <ul>
 * <li>The NPC sells bilet do niebios to players above level 300</li>
 ...
 * </ul>
 */
public class ScrollHeaven extends AbstractQuest {
	...
	private static final String QUEST_SLOT = "heaven_bilet";
	...
	private void step_1() {
		final SpeakerNPC npc = npcs.get("HeavenNPC");
		...
		npc.add(
			...
			"Wróciłeś po kolejny bilet do niebios?", null);
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				ConversationStates.ATTENDING, 
				"W porządku oto twój bilet do niebios. Gdy użyjesz to wrócisz za około 3 godziny. Jeśli będziesz chciał wcześniej wrócić to skorzystaj tam stan na herbie Zakopanego, który zabierze Ciebie z powrotem.",
				new MultipleActions(
						new DropItemAction("money", REQUIRED_MONEY),
						new EquipItemAction("bilet do niebios", 1, true),
		...
		npc.add(ConversationStates.ATTENDING,
			Arrays.asList("deal", "ticket", "bilet do niebios", "yes", "tak"),
			new LevelGreaterThanCondition(REQUIRED_LEVEL-1),
			ConversationStates.ATTENDING,
	...
	public void addToWorld() {
		...
		SingletonRepository.getLoginNotifier().addListener(new LoginListener() {
			public void onLoggedIn(final Player player) {
			    HeavenScroll scroll = (HeavenScroll) SingletonRepository.getEntityManager().getItem("bilet do niebios");
		...
		fillQuestInfo(
				"bilet do niebios",
				"bilet do niebios wysyła na wycieczkę do obcej krainy pokrytej piaskiem.",
				false);
		step_1();

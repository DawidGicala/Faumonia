/* $Id: ScrollAngel.java,v 1.46 2012/04/19 18:26:42 kymara Exp $ */
/***************************************************************************
...
import games.stendhal.server.entity.item.scroll.AngelScroll;
 ...
 * PARTICIPANTS:
 * <ul>
 * <li>AnielskiNPC, a dealer in anielski zwój
 * </ul>
 *
 * STEPS:
 * <ul>
 * <li>The NPC sells anielski zwój to players above level 300</li>
 ...
 * </ul>
 */
public class ScrollAngel extends AbstractQuest {
	...
	private static final String QUEST_SLOT = "anielski_bilet";
	...
	private void step_1() {
		final SpeakerNPC npc = npcs.get("AnielskiNPC");
		...
		npc.add(
			...
			"Wróciłeś po kolejny anielski zwój?", null);
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				ConversationStates.ATTENDING, 
				"W porządku oto twój anielski zwój. Gdy użyjesz to wrócisz za około 3 godziny. Jeśli będziesz chciał wcześniej wrócić to skorzystaj tam stan na herbie Zakopanego, który zabierze Ciebie z powrotem.",
				new MultipleActions(
						new DropItemAction("money", REQUIRED_MONEY),
						new EquipItemAction("anielski zwój", 1, true),
		...
		npc.add(ConversationStates.ATTENDING,
			Arrays.asList("deal", "ticket", "anielski zwój", "yes", "tak"),
			new LevelGreaterThanCondition(REQUIRED_LEVEL-1),
			ConversationStates.ATTENDING,
	...
	public void addToWorld() {
		...
		SingletonRepository.getLoginNotifier().addListener(new LoginListener() {
			public void onLoggedIn(final Player player) {
			    AngelScroll scroll = (AngelScroll) SingletonRepository.getEntityManager().getItem("anielski zwój");
		...
		fillQuestInfo(
				"anielski zwój",
				"anielski zwój wysyła na wycieczkę do obcej krainy pokrytej piaskiem.",
				false);
		step_1();

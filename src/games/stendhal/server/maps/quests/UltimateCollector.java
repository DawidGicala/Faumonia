/* $Id: UltimateCollector.java,v 1.30 2013/10/17 02:17:41 antumdeluge Exp $ */
/***************************************************************************
...
public class UltimateCollector extends AbstractQuest {
	...
	public List<String> getHistory(final Player player) {
		...
		if (isCompleted(player)) {
			res.add("Super. Jestem teraz największym kolekcjonerem broni! Mogę sprzedawać Balduinowi czarne przedmioty.");
		}
		return res;
	}
	...
	private void checkCollectingQuests() {
		...
		npc.add(ConversationStates.ATTENDING,
			...
			ConversationStates.ATTENDING, 
			"Wciąż masz do wykonania zadanie na miecz nieśmiertelnych. Szukaj dokładnie, a zostaniesz największym kolekcjonerem!",
			null);
		...
		npc.add(ConversationStates.ATTENDING,
			...
			ConversationStates.ATTENDING, 
			"W podziemnym mieście żyje krasnal kowal, który wykuje specjalną broń dla Ciebie. Nie możesz zostać największym kolekcjonerem bez tego przedmiotu.",
			null);
	...
	private void requestItem() {
		...
		items.put("nihonto",1); 
		items.put("zatruty sztylet egipski",1); 
		items.put("srebrny sztylet",1); 
		items.put("miecz dusz",1); 
		items.put("złota klinga",1);
		items.put("ognisty miecz demonów",1); 	
		items.put("sztylet arachne",1); 
		items.put("młot wulkanów",1); 
		...
		npc.add(ConversationStates.ATTENDING,
				...
				ConversationStates.ATTENDING, 
				null,
				new StartRecordingRandomItemCollectionAction(QUEST_SLOT, items, "Właśnie udowodniłeś mieszkańcom Faumonii, że możesz być największym kolekcjonerem,"
	...
	private void collectItem() {
		...
		npc.add(ConversationStates.QUEST_ITEM_QUESTION,
				...
				new MultipleActions(new DropRecordedItemAction(QUEST_SLOT), 
									...
									new IncreaseAtkXPAction(1000000),
									new IncreaseDefXPAction(1500000),
									new IncreaseKarmaAction(1000)));
	...
	private void offerSteps() {
		...
		npc.add(
				...
				ConversationStates.ATTENDING,
				"Kupię czarne przedmioty, ale tylko od prawdziwych kolekcjonerów.",
				null);
		...
		npc.add(ConversationStates.ATTENDING,
				...
				ConversationStates.ATTENDING,
				"Kupię czarne przedmioty po ukończeniu każdego #wyzwania , które ci postawie.", null);
	}

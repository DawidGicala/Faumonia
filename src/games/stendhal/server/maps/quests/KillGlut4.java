/* $Id: KillGlut4.java,v 1.32 2020/12/08 17:21:19 davvids Exp $ */
/***************************************************************************
 ...
 */
 ...
 public class KillGlut4 extends AbstractQuest {

	private static final String QUEST_NPC = "Zielony Glut";
	private static final String QUEST_SLOT = "kill_glut4";
	...
	public KillGlut4() {
		...
		enemyForces.put("orków górskich",
				new Pair<Integer, String>(50000,"... zapomniałeś?.. ...miałeś zabić orki górskie."));
	...
	public boolean isRepeatable(final Player player) {
 	...
 	public List<String> getHistory(final Player player) {
		...
		if(player.getQuest(QUEST_SLOT, 0).equals("start")) {
			...
			history.add("Zielony Glut kazał mi zabić armie "+
					givenNumber+" "+
			...
			if(new KilledInSumForQuestCondition(QUEST_SLOT, 2, givenNumber).fire(player, null, null)) {
				history.add("Zabiłem wystaczająco orków górskich, aby dostać moją nagrodę.");
			} else {
		...
		if (isRepeatable(player)) {
			history.add("Muszę znowu zabić grupę orków górskich.");
		} 

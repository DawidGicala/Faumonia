/* $Id: ZrodelkaTask1.java,v 1.46 2020/11/29 14:26:42 davvids Exp $ */
/***************************************************************************
...
import games.stendhal.server.entity.item.scroll.ZrodelkaTask1Scroll;
 ...
 * </ul>
 */
public class ZrodelkaTask1 extends AbstractQuest {
	...
	private static final String QUEST_SLOT = "zrodelka_nr_1";
	...
	private void step_1() {
		final SpeakerNPC npc = npcs.get("Ruben");
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				ConversationStates.ATTENDING, 
				"W porządku oto twój bilet na źródełka treningowe. Gdy go użyjesz to wrócisz za około 1 godzinę. Jeśli będziesz chciał wcześniej wrócić to skorzystaj ze schodów.",
				new MultipleActions(
						new DropItemAction("money", REQUIRED_MONEY),
						new EquipItemAction("źródełka treningowe I", 1, true),
						new TeleportAction("int_semos_skill_house", 13, 38, Direction.RIGHT),
	...
	public void addToWorld() {
		...
		SingletonRepository.getLoginNotifier().addListener(new LoginListener() {
			public void onLoggedIn(final Player player) {
			    ZrodelkaTask1Scroll scroll = (ZrodelkaTask1Scroll) SingletonRepository.getEntityManager().getItem("źródełka treningowe I");

/* $Id: KillGlut1.java,v 1.32 2020/12/08 17:01:19 davvids Exp $ */
/***************************************************************************
 ...
 */
 ...
 public class KillGlut1 extends AbstractQuest {

	private static final String QUEST_NPC = "Fioletowy Glut";
	private static final String QUEST_SLOT = "kill_glut1";
	...
	public KillGlut1() {
		...
		enemyForces.put("amazonek",
				new Pair<Integer, String>(50000,"... zapomniałeś?.. ...miałeś zabić Amazonki.."));
	...
	public boolean isRepeatable(final Player player) {
 	...
 	public List<String> getHistory(final Player player) {
		...
		if(player.getQuest(QUEST_SLOT, 0).equals("start")) {
			...
			history.add("Fioletowy Glut kazał mi zabić armie "+
					givenNumber+" "+
		...
		if(isCompleted(player)) {
			history.add("Pokonałem Amazonki i w zamian dostałem gigantyczne eliksiry.");
		}	
		if (isRepeatable(player)) {
			history.add("Muszę znowu zabić Amazonki.");
		} 

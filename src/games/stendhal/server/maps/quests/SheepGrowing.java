...
public class SheepGrowing extends AbstractQuest {
	...
	private static final String TITLE = "Owce Nishiya";
	...
	public void addToWorld() {
		...
		fillQuestInfo(
				...
				"Nishiya, sprzedawca owiec, obiecał Sato, że da mu owcę. " +
					...
					"jedną z owiec i przyprowadzenie jej do Sato.",
				true);
	...
	public List<String> getHistory(final Player player) {
		...
		res.add("Nishiya zapytał mnie, czy mógłbym zająć się jego owcą.");
		...
		if (player.isQuestInState(QUEST_SLOT, "start", "handed_over", "done")) {
			res.add("Obiecuję zaopiekować się jedną z jego owiec. Musze nakarmić ją jagodami rosnącymi na pobliskich krzaczkach a następnie odnieść Sato.");
		}
	...
	private void preparePlayerGetsSheepStep() {
		...
		npc.add(
				...
				"Trzeba tylko ją utuczyć - pozwolić jej jeść czerwone jagody z krzewów, dopóki nie będzie ważyć " + Sheep.MAX_WEIGHT + " kilo." +
				"Zająłbyś się tym?",

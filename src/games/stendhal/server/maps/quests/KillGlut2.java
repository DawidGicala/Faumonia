/* $Id: KillGlut2.java,v 1.32 2020/12/08 17:01:19 davvids Exp $ */
/***************************************************************************
 ...
 */
 ...
 public class KillGlut2 extends AbstractQuest {

	private static final String QUEST_NPC = "Żółty Glut";
	private static final String QUEST_SLOT = "kill_glut2";
	...
	public KillGlut2() {
		...
		enemyForces.put("żołnierzy mithrilu",
				new Pair<Integer, String>(50000,"... zapomniałeś?.. ...miałeś zabić żołnierzy mithrilu.."));
	...
	public boolean isRepeatable(final Player player) {
 	...
 	public List<String> getHistory(final Player player) {
		...
		if(player.getQuest(QUEST_SLOT, 0).equals("start")) {
			...
			history.add("Żółty Glut kazał mi zabić armie "+
					givenNumber+" "+
		...
		if(isCompleted(player)) {
			history.add("Pokonałem żołnierzy mithrilu i w zamian dostałem gigantyczne eliksiry.");
		}	
		if (isRepeatable(player)) {
			history.add("Muszę znowu zabić żołnierzy mithrilu.");
		} 

...
public class FruitsForCoralia extends AbstractQuest {
	...
	public List<String> getHistory(final Player player) {
		...
		if ("rejected".equals(questState)) {
			...
			res.add("Przyniosłem Coralii owoce, których potrzebowała do swojego kapelusza, a ona zastąpiła nimi stare, które utraciły blask.	W nagrodę za ukończenie zadania otrzymałem: 10.000 pkt doświadczenia, 50 pkt karmy, naleśniki z polewą czekoladową i trochę dużych eliksirów.");
		}
		return res;
	}
	...
	private void prepareBringingStep() {
		...
		ChatAction completeAction = new  MultipleActions(
			...
			new EquipRandomAmountOfItemAction("naleśniki z polewą czekoladową", 1, 3),
			new EquipRandomAmountOfItemAction("duży eliksir", 10, 30),

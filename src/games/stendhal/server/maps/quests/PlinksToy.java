...
public class PlinksToy extends AbstractQuest {
	...
	public List<String> getHistory(final Player player) {
		...
		if (questState.equals("rejected")) {
			res.add("Powinienem szukać pluszowego misia Plinka w pobliżu wilków");
			return res;
		}
		res.add("Musze pomóc Plinkowi w szukaniu jego misia");
		if ((player.isEquipped("pluszowy miś")) || isCompleted(player)) {
			res.add("Znalazłem pluszowego misia Plinka	W nagrodę za ukończenie zadania otrzymałem: 200 pkt doświadczenia, 150 pkt obrony, 100 pkt ataku i 30 karmy.");
		}
	...
	private void step_3() {
		...
		reward.add(new IncreaseAtkXPAction(100));
		reward.add(new IncreaseDefXPAction(150));
		reward.add(new SetQuestAction(QUEST_SLOT, "done"));
		reward.add(new IncreaseKarmaAction(30));
	...
	public void addToWorld() {
		...
		fillQuestInfo(
				"Zabawka Plinka",
				"Plink chce, abym odnalazł jego misia, powinienem go szukać w okolicy wilków na połnoc od miasta Semos.",
				false);
		step_1();
		step_2();
		step_3();

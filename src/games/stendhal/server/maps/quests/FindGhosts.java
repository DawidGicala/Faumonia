...
public class FindGhosts extends AbstractQuest {
	...
	private void askingStep() {
		...
		npc.add(ConversationStates.ATTENDING,
			...
			ConversationStates.ATTENDING,
			"Dziękuję! Czuję się teraz lepiej znając imiona innych duchów Faumonii.",
			null);
		...
		npc.add(ConversationStates.QUEST_OFFERED,
			...
			null,
			ConversationStates.ATTENDING,
			"To wspaniale z twojej strony. Powodzenia w szukaniu ich. Jeśli one na prawde istnieją to jeden powinien krążyć po naszym mieście, inny zamieszkuje podziemne miasto Wofol, kolejnego powinieneś szukać w podziemiach tropikalnej wyspy a ostatni krąży po szczurzym mieście.",
	...
	public void addToWorld() {
		...
		fillQuestInfo(
				"Poszukiwania Duchów",
				"Pewnego razu paru podróżnych rozmawiało z duchami, które odwiedziły ich podczas podróży przez Faumonie. Jeden z nich młody duch zwany Carena ukryty gdzieś w okolicach Ados potrzebuje pomocy...",
				true);
		askingStep();
		findingStep();
		tellingStep();
	...
	public List<String> getHistory(final Player player) {
			...
			res.add("Carena jest samotna i chce wiedzieć o innych duchach na świecie. Muszę znaleźć je wszystkie i powiedzieć jej, ich imiona. Na poszukiwania powinienem wybrać sie do stolicy, w podziemia tropikalnej wyspy, do szczurzego miasta oraz podziemnego miasta Wofol.");
			...
			if (!isCompleted(player)) {
				...
				res.add("Carena ucieszyła się, że są inne duchy na świecie. Za moje zaangażowanie podniosła moją żywotność.	W nagrodę za ukończenie zadania otrzymałem: 10.000 pkt doświadczenia, 5.000 pkt ataku, 5.000 pkt obrony, 50 pkt karmy i 50 pkt maksymalnego życia.");
			}
			return res;
	}

/* $Id: SkillerTask1.java,v 1.46 2012/04/19 18:26:42 kymara Exp $ */
/***************************************************************************
...
import games.stendhal.server.entity.item.scroll.SkillerTask1Scroll;
 ...
 * </ul>
 */
public class SkillerTask1 extends AbstractQuest {

	private static final int REQUIRED_LEVEL = 1;

	private static final int REQUIRED_MONEY = 100;

	private static final int REQUIRED_MINUTES = 1 * 0;

	private static final String QUEST_SLOT = "skiller_nr_1";
	...
	private void step_1() {
		final SpeakerNPC npc = npcs.get("Azan");
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				ConversationStates.ATTENDING, 
				"W porządku oto twój bilet na arenę treningową. Gdy go użyjesz to wrócisz za około 1 godzinę. Jeśli będziesz chciał wcześniej wrócić to skorzystaj ze schodów.",
				new MultipleActions(
						new DropItemAction("money", REQUIRED_MONEY),
						new EquipItemAction("bilet treningowy I", 1, true),
						new TeleportAction("int_semos_skill_house", 18, 38, Direction.LEFT),
	...
	public void addToWorld() {
		...
		SingletonRepository.getLoginNotifier().addListener(new LoginListener() {
			public void onLoggedIn(final Player player) {
			    SkillerTask1Scroll scroll = (SkillerTask1Scroll) SingletonRepository.getEntityManager().getItem("bilet treningowy I");

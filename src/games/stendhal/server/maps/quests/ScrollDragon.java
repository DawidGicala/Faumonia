/* $Id: ScrollDragon.java,v 1.46 2012/04/19 18:26:42 kymara Exp $ */
/***************************************************************************
...
import games.stendhal.server.entity.item.scroll.DragonScroll;
 ...
 * PARTICIPANTS:
 * <ul>
 * <li>SmoczyNPC, a dealer in smoczy zwój
 * </ul>
 *
 * STEPS:
 * <ul>
 * <li>The NPC sells smoczy zwój to players above level 300</li>
 ...
 * </ul>
 */
public class ScrollDragon extends AbstractQuest {
	...
	private static final String QUEST_SLOT = "smoczy_bilet";
	...
	private void step_1() {
		final SpeakerNPC npc = npcs.get("SmoczyNPC");
		...
		npc.add(
			...
			"Wróciłeś po kolejny smoczy zwój?", null);
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				ConversationStates.ATTENDING, 
				"W porządku oto twój smoczy zwój. Gdy użyjesz to wrócisz za około 3 godziny. Jeśli będziesz chciał wcześniej wrócić to skorzystaj tam stan na herbie Zakopanego, który zabierze Ciebie z powrotem.",
				new MultipleActions(
						new DropItemAction("money", REQUIRED_MONEY),
						new EquipItemAction("smoczy zwój", 1, true),
		...
		npc.add(ConversationStates.ATTENDING,
			Arrays.asList("deal", "ticket", "smoczy zwój", "yes", "tak"),
			new LevelGreaterThanCondition(REQUIRED_LEVEL-1),
			ConversationStates.ATTENDING,
	...
	public void addToWorld() {
		...
		SingletonRepository.getLoginNotifier().addListener(new LoginListener() {
			public void onLoggedIn(final Player player) {
			    DragonScroll scroll = (DragonScroll) SingletonRepository.getEntityManager().getItem("smoczy zwój");
		...
		fillQuestInfo(
				"smoczy zwój",
				"smoczy zwój wysyła na wycieczkę do obcej krainy pokrytej piaskiem.",
				false);
		step_1();

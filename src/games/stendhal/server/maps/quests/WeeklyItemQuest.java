...
public class WeeklyItemQuest extends AbstractQuest {
	...
	private static final int expireDelay = MathHelper.MINUTES_IN_ONE_WEEK * 1; 
	...
	private static void buildItemsMap() {
		...
		items.put("sztabka mithrilu",33);
		items.put("bryłka mithrilu",35);
	...
	private void completeQuest() {
		...
		actions.add(new EquipItemAction("skrzynia skarbów IV", 1));

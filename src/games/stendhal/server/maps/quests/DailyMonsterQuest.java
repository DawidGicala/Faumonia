...
public class DailyMonsterQuest extends AbstractQuest {
	...
	public List<String> getHistory(final Player player) {
		...
		res.add("Odwiedziłem ratusz Semos");
		...
		if (player.isQuestCompleted(QUEST_SLOT)) {
			...
			if (timeRemaining > 0L) {
				res.add("Zabiłem ostatniego potwora o którego mnie prosili odebrałem nagrodę w ciągu 24 godzin.");
			} else {
				res.add("Zabiłem ostatniego potwora o którego mnie prosili teraz Semos znów potrzebuje mojej pomocy.");
			}
		}
	...
	private void step_3() {
		...
		npc.add(ConversationStates.ATTENDING,
				...
				new MultipleActions(
						...
						new IncreaseDefXPAction(6000),
						new EquipItemAction("skrzynia skarbów II", 1),

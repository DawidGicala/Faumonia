/* $Id: ScrollMaleus.java,v 1.46 2012/04/19 18:26:42 kymara Exp $ */
/***************************************************************************
...
import games.stendhal.server.entity.item.scroll.MaleusScroll;
 ...
 * PARTICIPANTS:
 * <ul>
 * <li>MaleusNPC, a dealer in demoniczny zwój
 * </ul>
 *
 * STEPS:
 * <ul>
 * <li>The NPC sells demoniczny zwój to players above level 300</li>
 ...
 * </ul>
 */
public class ScrollMaleus extends AbstractQuest {
	...
	private static final String QUEST_SLOT = "maleus_bilet";
	...
	private void step_1() {
		final SpeakerNPC npc = npcs.get("MaleusNPC");
		...
		npc.add(
			...
			"Wróciłeś po kolejny demoniczny zwój?", null);
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				ConversationStates.ATTENDING, 
				"W porządku oto twój demoniczny zwój. Gdy użyjesz to wrócisz za około 3 godziny. Jeśli będziesz chciał wcześniej wrócić to skorzystaj tam stan na herbie Zakopanego, który zabierze Ciebie z powrotem.",
				new MultipleActions(
						new DropItemAction("money", REQUIRED_MONEY),
						new EquipItemAction("demoniczny zwój", 1, true),
		...
		npc.add(ConversationStates.ATTENDING,
			Arrays.asList("deal", "ticket", "demoniczny zwój", "yes", "tak"),
			new LevelGreaterThanCondition(REQUIRED_LEVEL-1),
			ConversationStates.ATTENDING,
	...
	public void addToWorld() {
		...
		SingletonRepository.getLoginNotifier().addListener(new LoginListener() {
			public void onLoggedIn(final Player player) {
			    MaleusScroll scroll = (MaleusScroll) SingletonRepository.getEntityManager().getItem("demoniczny zwój");
		...
		fillQuestInfo(
				"demoniczny zwój",
				"demoniczny zwój wysyła na wycieczkę do obcej krainy pokrytej piaskiem.",
				false);
		step_1();

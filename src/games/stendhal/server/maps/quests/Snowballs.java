...
public class Snowballs extends AbstractQuest {
	...
	public List<String> getHistory(final Player player) {
		...
		if (isCompleted(player)) {
			res.add("Sprawiłem, że Pan Yeti poczuł się szczęśliwy, gdy dałem mu śnieżki, o które prosił.	W nagrodę za ukończenie zadania otrzymałem: 1.000 pkt doświadczenia, 1.000 pkt ataku, 1.000 pkt obrony, 20 pkt karmy i trochę ryb.");
		}
	...
	private void prepareBringingStep() {
		...
		reward.add(new IncreaseAtkXPAction(1000));
		reward.add(new IncreaseDefXPAction(1000));
	...
	public void addToWorld() {
		...
		fillQuestInfo(
				"Śnieżki dla Mr. Yeti",
				"Mieszkańcy lodowego regionu w Faumonii potrzebują twojej pomocy w uzbieraniu kilku śnieżek dla nich.",
				false);

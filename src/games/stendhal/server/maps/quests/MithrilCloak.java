...
public class MithrilCloak extends AbstractQuest {
	...
	public void addToWorld() {
		...
		fillQuestInfo(
				"Płaszcz z Mithrilu",
				"Jesteś zainteresowany błyszczącym w słońcu płaszczem? Powinieneś porozmawiać z Idą mieszkającą w stolicy Faumonii.",
				false);
	...
	public List<String> getHistory(final Player player) {
    	...
    	res.add("Poznałem Idę w szwalni w Ados");
        if (questState.equals("rejected")) {
			res.add("Nie jestem zainteresowany pomocą Idzie.");
			return res;
		}
        res.add("Idy maszyna do szycia jest uszkodzona, więc zwróciła się do mnie abym znalazł brakujące części.");
		...
		res.add("Mój płaszcz potrzebuje tkaniny z mithrilu i Kampusch mi pomoże. Pracuje w muzeum Kirdneh i na pewno bedzie wiedział jakie przedmioty trzeba.");
		...
		res.add("Zaniosłem Kampuschowi jedwabne nici, króre odebrałem od Vincenta studenta, Boris Karlova.");
		...
		res.add("Whiggins zrobi mi tkanine z mithrilu. Muszę go odnaleść. Podobno mieszka w jakimś podziemnym mieście na południu...");
		if (questState.equals("got_mithril_thread")) {
			return res;
		}
		res.add("Nim Whiggins mi pomoże muszę zanieść list do Pedinghaus w kuźni Ados. Whiggins wydaje się naprawdę zmartwiony.");
		...
		res.add("Ida nie potnie tkaniny zwykłymi nożyczkami. Powinienem udać się do krasnoludzkiego kowala Hogarta po specjalne nożyczki.");
		if (questState.equals("need_scissors")) {
			return res;
		}
		res.add("Hogart nie da mi nożyczek nim nie przyniosę żelaza, sztabki mithrilu, i magicznych skorupek.");
		...
		res.add("Dałem Idzie eliksir mroku, aby przywrócić jej zdrowie. Teraz dała mi inne zadanie. Muszę iść i znaleźć prążkowany płaszcz lazurowy, który zaniosę do Josephine. W tym czasie Ida może szyć mój płaszcz.");
		...
		res.add("Mój płaszcz jest już prawie gotowy, wszystko co potrzebuję to zapięcie z mithrilu od Pedinghausa.");

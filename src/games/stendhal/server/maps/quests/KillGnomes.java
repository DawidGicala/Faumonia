...
public class KillGnomes extends AbstractQuest {
	...
	private static final int WEEK_IN_MINUTES = MathHelper.MINUTES_IN_ONE_HOUR * 24 * 2;
	...
	private void step_1() {
		...
		toKill.put("gnom", new Pair<Integer, Integer>(0,20));
		toKill.put("gnom zwiadowca", new Pair<Integer, Integer>(0,10));
		toKill.put("gnom kawalerzysta",new Pair<Integer, Integer>(0,10));
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				null,
				ConversationStates.ATTENDING,
				"Doskonale. Obozowisko gnomów znajdziesz na północny-zachód od Semos. Upewnij się, że ubiłeś 20 gnomów, conajmniej 10 zwiadowców i 10 kawalerzystów.",
	...
	private void step_3() {
		...
		final List<ChatAction> actions = new LinkedList<ChatAction>();
	    actions.add(new EquipItemAction("eliksir", 30));
		...
		npc.add(ConversationStates.ATTENDING, 
				...
				+ "Upewnij się, że zabiłeś 20 gnomów, co najmniej 10 zwiadowców i 10 kawalerzystów.",
				null);
	}
	...
	public void addToWorld() {
		...
		fillQuestInfo(
				"Zabij Gnomy",
				"Pomocy! Gnomy ukradły marchewki młynarzowej Jenny! Idź do wioski gnomów, położonej na północny-zachód od Semos i zemścij się w jej imieniu.",
				false);
		step_1();
		step_2();
		step_3();
	...
	public List<String> getHistory(final Player player) {
			...
			if (!isCompleted(player)) {
				res.add("Muszę zabić 20 gnomów, 10 kawalerzystów 10 zwiadowców, dam im wszystkim lekcje pokory!");
			} else if(isRepeatable(player)){
				res.add("Te brzydkie gnomy, zapomniały lekcji jaką im dałem. Kradną jeszcze więcej! Jenny potrzebuje mojej pomocy.");
			} else {
				res.add("Pomogłem Jenny. Gnomy trzymają się teraz z dala od marchewek. Hura!	W nagrodę za ukończenie zadania otrzymałem: 1.000 pkt doświadczenia i 30 eliksirów.");
			}
			return res;
	}

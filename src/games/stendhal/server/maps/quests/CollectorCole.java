/* $Id: CollectorCole.java,v 1.58 2012/04/24 17:01:18 kymara Exp $ */
/***************************************************************************
 ...
 * PARTICIPANTS:
 * <ul>
 * <li> Kolekcjoner Cole, son of Zeus itself, will forge for you the god's sword.
 * </ul>
 * 
 * STEPS:
 * <ul>
 * <li> Kolekcjoner Cole tells you about the sword.
 ...
 * <li> Kolekcjoner Cole forges the immortal sword for you
 * </ul>
 * 
 * REWARD:
 * <ul>
 ...
 * </ul>
 */
public class CollectorCole extends AbstractQuest {
	private static final int REQUIRED_IRON = 80333;

	private static final int REQUIRED_GOLD_BAR = 25;
	...
	private static final String QUEST_SLOT = "kolekcjoner_cole_quest";
	...
	private void step_1() {
		final SpeakerNPC npc = npcs.get("Kolekcjoner Cole");
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
			...
			ConversationStates.IDLE, null, new ChatAction() {
				public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
					...
					player.addXP(50000);
					player.addatk_xp(10000);
					player.adddef_xp(10000);
					player.addKarma(25);
	...
	public void addToWorld() {
		super.addToWorld();
		fillQuestInfo(
				"Rzeczy dla Kolekcjoner Colea",
				"Kolekcjoner Cole syn Zeusa wykuje dla Ciebie boski miecz.",
				false);
		step_1();
		step_2();
		step_3();
	...
	public List<String> getHistory(final Player player) {
			...
			res.add("Spotkałem Kolekcjoner Cole w Kotoch.");
			...
			if(questState.startsWith("start") && !"start;15;26;12;6".equals(questState)){
				...
				res.add("Dostarczyłem wszystko co potrzebne dla Kolekcjoner Cole.");
			}
			...
			if (questState.startsWith("forging")) {
				res.add("Kolekcjoner Cole, syn Zeusa wykuwa mi miecz.");
			} 

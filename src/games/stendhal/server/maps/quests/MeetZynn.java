	...
	private void step_1() {
		...
		npc
				.addReply(
						...
						"Mapę FaumoniaOnline możesz zobaczyć na stronie gry jeżeli chcesz. Nie spodziewaj się, że będą na niej oznaczone potwory!");

		npc
				.addReply(
						"SPPOL",
						"SPPOL znaczy System Pozycjonowania FaumoniaOnline. Możesz zapytać #Io w Świątyni o szczegóły jak to działa. W zasadzie pozwala Tobie ustalić dokładną lokację siebie lub przyjaciela.");

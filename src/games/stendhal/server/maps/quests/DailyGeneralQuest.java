...
public class DailyGeneralQuest extends AbstractQuest {
	...
	private static void buildItemsMap() {
		...
		items.put("skóra zielonego smoka",3);
		items.put("skóra zielonego smoka",1);
		items.put("skóra zielonego smoka",4);
		items.put("skóra zielonego smoka",6);
		items.put("skóra niebieskiego smoka",1);
		items.put("skóra niebieskiego smoka",2);
		items.put("skóra czerwonego smoka",2);
		items.put("skóra czerwonego smoka",5);
		items.put("skóra czerwonego smoka",3);
		items.put("skóra czarnego smoka",2);
		items.put("skóra czarnego smoka",3);
		items.put("skóra czarnego smoka",1);
		items.put("skóra złotego smoka",2);
		items.put("skóra złotego smoka",1);
		items.put("kieł smoka",3);
		items.put("kieł smoka",15);
		items.put("kieł smoka",8);
		items.put("kieł smoka",5);
		items.put("kieł smoka",11);
		items.put("szmaragd",6);
		items.put("szmaragd",12);
		items.put("szmaragd",3);
		items.put("szmaragd",7);
		items.put("szmaragd",9);
		items.put("rubin",4);
		items.put("rubin",2);
		items.put("rubin",7);
		items.put("rubin",5);
		...
		items.put("szafir",5);
		items.put("szafir",2);
		items.put("sztabka złota",8);
		items.put("sztabka złota",20);
		items.put("sztabka złota",16);
		items.put("sztabka złota",4);
		items.put("sztabka złota",12);
		items.put("sztabka mithrilu",2);
		items.put("sztabka mithrilu",1);
		items.put("sztabka mithrilu",3);
		items.put("diament",1);
		items.put("róg demona",1);
		items.put("pióro archanioła",1);
		items.put("pióro archanioła",2);
		items.put("pióro upadłego anioła",3);
		items.put("pióro upadłego anioła",5);
		items.put("pióro upadłego anioła",4);
		items.put("pióro upadłego anioła",2);
		items.put("pióro anioła",2);
		items.put("pióro anioła",4);
		items.put("pióro anioła",3);
		items.put("pióro mrocznego anioła",1);
		items.put("serce olbrzyma",8);
		items.put("serce olbrzyma",21);
		items.put("serce olbrzyma",26);
		items.put("serce olbrzyma",18);
		items.put("serce olbrzyma",14);
		items.put("serce olbrzyma",12);
		items.put("żelazo",6);
		items.put("żelazo",9);
		items.put("żelazo",7);
		items.put("ząb potwora",1);
		items.put("skóra zwierzęca",40);
		items.put("skóra zwierzęca",30);
		items.put("skóra zwierzęca",25);
		items.put("skóra zwierzęca",20);
		items.put("skóra zwierzęca",15);
		items.put("skóra zwierzęca",10);
		items.put("skóra zwierzęca",45);
		items.put("skóra zwierzęca",50);
		items.put("skóra lwa",3);
		items.put("skóra lwa",2);
		items.put("skóra lwa",1);
		items.put("skóra lwa",6);
		items.put("skóra tygrysa",1);
		items.put("skóra tygrysa",2);
		items.put("skóra tygrysa",3);
		items.put("skóra tygrysa",6);

...
public class MainTask1 extends AbstractQuest {
	...
	private void step_3() {
		...
		npc.add(ConversationStates.ATTENDING, 
				...
				+ "Zasługujesz na odznakę wojownika Faumonii pierwszego poziomu, zwiększy ona twoją obronę. Po nastepne główne zadanie powinieneś przyjść do Mistrza Faumonii II po przekroczeniu 5 poziomu doświadczenia.",
				new MultipleActions(actions));

/* $Id: DailyMonsterQuest2.java,v 1.80 2011/11/13 17:13:16 kymara Exp $ */
/***************************************************************************
...
public class DailyMonsterQuest2 extends AbstractQuest {

	private static final String QUEST_SLOT = "daily";
	private final SpeakerNPC npc = npcs.get("Urzędnik Bill");
	private static Logger logger = Logger.getLogger("DailyMonsterQuest2");
	...
	public List<String> getHistory(final Player player) {
		...
		res.add("Spotkałem się z Urzędnikiem Billem w ratuszu Semos");
		final String questState = player.getQuest(QUEST_SLOT);
		if ("rejected".equals(questState)) {
			res.add("Nie chcę pomóc Billowi.");
			return res;
		}

		res.add("Chcę pomóc Billowi.");
		...
		if (player.isQuestCompleted(QUEST_SLOT)) {
			...
			if (timeRemaining > 0L) {
				res.add("Zabiłem ostatniego potwora o którego prosił mnie Urzędnik Bill i odebrałem nagrodę w ciągu 24 godzin.");
			} else {
				res.add("Zabiłem ostatniego potwora o którego prosił mnie Urzędnik Bill i teraz znów potrzebuje mojej pomocy.");
			}
		}
	...
	public void addToWorld() {
		super.addToWorld();
		fillQuestInfo(
				"Dzienne Zadanie na potwora u Urzędnika Billa",
				"Urzędnik Bill potrzebuje wojowników do utrzymania bezpieczeństwa w mieście Semos.",
				true);
		step_1();
		step_2();
		step_3();

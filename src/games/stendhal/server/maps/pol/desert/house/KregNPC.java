/* $Id: KregNPC.java,v 1.5 2020/12/08 15:51:04 davvids Exp $ */
/***************************************************************************
 ...
 * @author kymara
 */
public class KregNPC implements ZoneConfigurator {
	...
	private void buildTavern(final StendhalRPZone zone, final Map<String, String> attributes) {
		final SpeakerNPC barman = new SpeakerNPC("Kreg") {
		...
		barman.setEntityClass("experiencedwarriornpc");
		barman.setPosition(12, 6);
		barman.initHP(100);
		barman.setDescription("Oto Kreg. Sprawia wrażenie oderwanego od rzeczywistości.");
		zone.add(barman);
	}
}

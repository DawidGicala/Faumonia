/* $Id: SupportAnswerAction.java,v 1.41 2013/04/27 09:15:12 kiheru Exp $ */
/***************************************************************************
...
public class SupportAnswerAction extends AdministrationAction implements TurnListener  {
	...
	public void perform(final Player player, final RPAction action) {
		...
		if (supported != null) {
			...
			DBCommand command = new StoreMessageCommand(getAnonymisedAdminName(sender), action.get(TARGET), "\n" + reply + " \nJeżeli chcesz odpowiedzieć użyj /support.", "S");

...
public class SupportMessageTemplatesFactory {
	...
	private void registerTemplates() {
		...
		addTemplate("$bugstracker","Cześć %s. Wygląda na to, że znalazłeś nowy błąd. Gdybyś mógł zostawić wiadomośc ze szczegółowym opisem jak do tego doszło na #http://www.pol.FaumoniaOnline.org/bugzilla to byłbym wdzięczny - bardzo dziękuję.");
		addTemplate("$faq", "Cześć. Odpowiedź na swoje pytanie znajdziesz w FAQ, który jest bardzo pomocny więc przeczytaj go uważnie! #http://www.faumonia.pl/faq. Dziękujemy, że jesteś z nami!");
		addTemplate("$faqpvp","Witaj %s i przykro słyszeć o tym. Przeczytaj uważnie regulamin dostępny na http://www.faumonia.pl/regulamin-gry-FaumoniaOnline-mmorpg - powodzenia w przyszłości.");
		...
		addTemplate("$notsupport","Cześć %s. Nie możemy pomóc Tobie w tym problemie. Skorzystaj z #http://www.pol.FaumoniaOnline.org/bugzilla.");
		...
		addTemplate("$rules","Cześć %s. Przeczytaj uważnie Regulamin FaumoniaOnline wpisując komendę #/rules - dziękuję.");

...
public class Bootstrap {
	...
	public void saveBootProp() throws IOException {
		...
		if (!bootProp.equals(bootPropOrg)) {
			...
			try {
				bootProp.store(os, "FaumoniaOnline Boot Configuration");
			} finally {
				os.close();
			}
		}
	...
	ClassLoader createClassloader(boolean includeUpdates, boolean firstPhase) throws Exception {
		...
		String[] includedJarFiles = new String[] { "lib/log4j.jar", "lib/marauroa.jar", "lib/jorbis.jar",
				"lib/FaumoniaOnline.jar", "lib/FaumoniaOnline-data.jar", "lib/FaumoniaOnline-sound-data.jar",
				"lib/FaumoniaOnline-music-data.jar"};
	...
	void unexpectedErrorHandling(String message, final Throwable t) {
		...
		if (e instanceof OutOfMemoryError) {
			...
			JOptionPane.showMessageDialog(
					null,
					new SelectableLabel(
					message + "Wystąpił niespodziewany błąd.\r\nPrzejdź do formularza kontaktowego na http://www.faumonia.pl/kontakt-gmgags i napisz wiadomość o błędzie:\r\n"
							+ errorMessage));
		}
		System.exit(1);
	}

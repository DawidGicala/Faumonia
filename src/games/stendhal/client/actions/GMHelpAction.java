...
class GMHelpAction implements SlashAction {
	...
	public boolean execute(final String[] params, final String remainder) {
		...
		if (params[0] == null) {
			lines = Arrays.asList(
				"Aby dowiedzieć się więcej odwiedź #http://www.faumonia.pl",
			...
			if ("alter".equals(params[0])) {
				...
				lines = Arrays.asList(
					...
					"Lista raidów 0-50lvl: Animal, Farm, Beholder, Fairy, Gnome, Kobold, UndeadEasy, Zbojnicy, Rat, Risecia, Kalavan, Duchy, Orc,  ",
					"Lista raidów: 50-100lvl: Dwarf, Elemental, Elf, Frogman, SheepMan, UndeadHard, Ninja, ",
					"Lista raidów: 100-250lvl: Barbarian, Superczlowiek, Chaos, DarkElf, Spider, Imperial, Vampire, Oni, Ptaki, AlbinoElf, Giant, Assassin, Ent, Stone, Madaram, Magicy, Dreamscape, Balor,   ",
					"Lista raidów: 250lvl+: GiantHard, Angel, AngelHard, DragonEasy, DragonHard, DragonUltraHard, Mithril, DwarfMountain, OrcMountain, Amazon, Death "
					);

...
public class WoodStyle implements Style {
	...
	private static final Color highLightColor = new Color(163, 163, 163);
	private static final Color shadowColor = new Color(59, 59, 59);
	private static final Color plainColor = new Color(102, 102, 102);
	...
	public WoodStyle() {
		...
		background = st.getSprite("data/gui/panelmetal003.jpg");

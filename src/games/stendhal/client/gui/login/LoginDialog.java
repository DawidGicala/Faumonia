...
public class LoginDialog extends JDialog {
	...
	public void connect(final Profile profile) {
		...
		try {
			...
			handleError("Uruchomiłeś starszą wersję FaumoniaOnline. Proszę zaktualizuj",
					"Starsza wersja");
			...
			handleError("Twoje IP zostało zablokowane. Jeżeli nie zgadzasz się z tą decyzją to skontaktuj się z nami na http://www.faumonia.pl/kontakt-gmgags",
					"Zablokowane IP");
		}
	}

...
public final class CharacterDialog extends JDialog implements Runnable {
	...
	private void chooseCharacter(final String character) {
		try {
			...
			logger.error(e, e);
			handleError("Twoja wersja FaumoniaOnline jest niekompatybilna z wersją serwera.", "Wybierz Postać");
	...
	static class CreateCharacterAction implements ActionListener {
		...
		public void actionPerformed(final ActionEvent evt) {
			...
			try {
				...
				logger.error(e, e);
				parent.handleError("Twoja wersja FaumoniaOnline jest niekompatybilna z wersją serwera.", "Wybierz Postać");
			} catch (BannedAddressException e) {
				logger.error(e, e);

/* $Id: j2DClient.java,v 1.428 2013/01/27 17:59:39 kiheru Exp $ */
/***************************************************************************
...
public class j2DClient implements UserInterface {
	...
	private void checkAndComplainAboutJavaImplementation() {
		...
		if ((vmName.indexOf("hotspot") < 0) && (vmName.indexOf("openjdk") < 0)) {
			final String text = "FaumoniaOnline jest przeznaczona i testowana dla Oracle Java i OpenJDK. Używasz "

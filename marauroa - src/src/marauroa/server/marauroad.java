	...
	private static void setArguments(String[] args) {
		...
		while (i != args.length) {
			if (args[i].equals("-c")) {
				...
				System.out.println("Translated to polish by edi18028");
				System.out.println();
	...
	public static void main(String[] args) {
		...
		try {
		  Log4J.init(log4jConfiguration);
			...
			System.out.println("B\u0141\u0104D: Marauroa nie mo\u017Ce zapisywa\u0107 do dziennika.");
			System.out.println("Sprawd\u017A czy masz utworzony katalog log/.");
			System.exit(1);
		}
		...
		try {
			...
			System.out.println("B\u0141\u0104D: Marauroa nie mo\u017Ce si\u0119 po\u0142\u0105czy\u0107 z baz\u0105 danych");
			System.out.println("Sprawd\u017A czy plik \"server.ini\" posiada dost\u0119p do bazy danych.");
			System.exit(1);
		}

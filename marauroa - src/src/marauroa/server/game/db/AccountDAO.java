	...
	public String getAccountBanMessage(DBTransaction transaction, String username) throws SQLException {
		try {
			...
			if (result.next()) {
				...
				if (reason != null) {
					if (expire != null) {
						res = "Twoje konto zosta\u0142o zawieszone na " + expire + " wg czasu serwera.\r\n";
					} else {
						res = "Twoje konto zosta\u0142o zablokowane.\r\n";
					}
					res = res + "Powodem by\u0142o: " + reason + "\r\n";
				} else if ("banned".equals(status)) {
					res = "Twoje konto zosta\u0142o zablokowane. Skontaktuj si\u0119 ze wsparciem.\r\n";
				} else if ("inactive".equals(status)) {
					res = "Twoje konto zosta\u0142o oznaczone jako nieaktywne. Skontaktuj si\u0119 ze wsparciem.\r\n";
				} else if ("merged".equals(status)) {
					res = "Twoje konto zosta\u0142o po\u0142\u0105czone z innym.\nZaloguj si\u0119 na to konto lub skontaktuj si\u0119 ze wsparciem.\r\n";
				}
